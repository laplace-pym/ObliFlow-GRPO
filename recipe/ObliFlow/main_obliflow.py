...
"""ObliFlow-GRPO recipe entry point."""
...
from recipe.ObliFlow.obliflow_ray_trainer import RayPPOTrainer
from verl.trainer.constants_ppo import get_ppo_ray_runtime_env


@hydra.main(config_path="config", config_name="obliflow_trainer", version_base=None)
def main(config):
    run_ppo(config)
...
class TaskRunner:
    def run(self, config):
        ...
        from recipe.ObliFlow.obliflow_ray_trainer import ResourcePoolManager, Role
